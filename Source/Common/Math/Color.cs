namespace EditorUI
{
    public struct Color
    {
        ...
        public static Color EDITOR_UI_MASK_COLOR = FromRGBA(61, 163, 255, 164);
        ...
        public static Color EDITOR_UI_SEPARATOR = EDITOR_UI_HILIGHT_COLOR_GRAY;

        public static Color TREE_ITEM_HILIGHT_COLOR_GRAY = FromRGBA(73, 73, 80, 255);

        public static Color TREE_ITEM_HILIGHT_COLOR_BLUE = FromRGBA(61, 163, 255, 255);

        public static Color BUTTON_BORDER_COLOR = EDITOR_UI_HILIGHT_COLOR_GRAY;
    }
}