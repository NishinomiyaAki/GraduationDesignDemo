...
namespace EditorUI
{
    public static class StringHelper
    {
        ...
        public static string IgnoreCaseReplace(string String, string OldValue, string NewValue)
        {
            return String.Replace(OldValue, NewValue, StringComparison.OrdinalIgnoreCase);
        }
        ...
        public static int FindLastString(string String, string Pattern)
        {
            return String.LastIndexOf(Pattern, System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool MatchPrefix(string String, string Prefix)
        {
            bool bIgnoreCase = false;
            return string.Compare(String, 0, Prefix, 0, Prefix.Length, bIgnoreCase) == 0;
        }
        ...
        private static TextFileLineEnding DefaultFileLineEnding = TextFileLineEnding.Windows;
